...
const M = {},
	...
	Y = [
		() =>
			X(
				() => import('./pages/__layout.svelte-0393a01c.js'),
				[
					'pages/__layout.svelte-0393a01c.js',
					'assets/pages/__layout.svelte-0e37233c.css',
					'chunks/vendor-c51b7936.js',
					'assets/vendor-7e835255.css'
				]
			),
		() =>
			X(
				() => import('./error.svelte-b019fc7e.js'),
				['error.svelte-b019fc7e.js', 'chunks/vendor-c51b7936.js', 'assets/vendor-7e835255.css']
			),
		() =>
			X(
				() => import('./pages/index.svelte-6b6f005a.js'),
				[
					'pages/index.svelte-6b6f005a.js',
					'assets/pages/index.svelte-127496a6.css',
					'chunks/vendor-c51b7936.js',
					'assets/vendor-7e835255.css'
				]
			)
